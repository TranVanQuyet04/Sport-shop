          ...
          <div className="relative hidden min-h-[560px] overflow-hidden bg-zinc-950 p-10 text-white lg:block">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end">
              ...
              <h2 className="mt-3 max-w-md text-4xl font-black leading-tight tracking-tight">
                Quáº£n lÃ½ Ä‘Æ¡n hÃ ng vÃ  Æ°u Ä‘Ã£i nhanh hÆ¡n.
              </h2>
              <p className="mt-4 max-w-md text-sm leading-7 text-white/75">
                ÄÄƒng nháº­p Ä‘á»ƒ theo dÃµi giá» hÃ ng, Ä‘á»‹a chá»‰ nháº­n hÃ ng vÃ  lá»‹ch sá»­
                mua sáº¯m cá»§a báº¡n.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                ChÃ o má»«ng báº¡n trá»Ÿ láº¡i. Vui lÃ²ng Ä‘Äƒng nháº­p tÃ i khoáº£n.
              </p>
            </div>
            ...
            <p className="mt-4 rounded-sm border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800">
              <strong>Test khi API lá»—i:</strong> test@StrideX.vn / Test123!
            </p>
