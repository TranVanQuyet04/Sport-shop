...
class RegisterPresenter extends ChangeNotifier {
  RegisterPresenter({required this.authRepository});
  ...
  String? get fullNameError =>
      !_hasSubmitted || _form.fullName.trim().isEmpty || _form.hasValidName
      ? null
  ...
  String? get phoneError =>
      !_hasSubmitted || _form.phoneNumber.trim().isEmpty || _form.hasValidPhone
      ? null
      : 'Số điện thoại chưa đúng định dạng.';
  String? get passwordError =>
      !_hasSubmitted || _form.password.isEmpty || _form.hasValidPassword
      ? null
